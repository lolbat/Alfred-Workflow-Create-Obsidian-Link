...
#### Changes
* Removed Keyword Input
* Changed Script Filter to allow it to filter Obsidian notes. Handy if you have a lot of them.
* Fixed incorrect image in Workflow Configuration in Alfred
